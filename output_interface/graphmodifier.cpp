...
const QString celsiusString = QString(QChar(0xB0));
GraphModifier::GraphModifier(Q3DBars *bargraph, float matriz[8][12])
    : m_graph(bargraph),
      m_xRotation(0.0f),
      m_yRotation(0.0f),
      m_fontSize(30),
      ...
      m_smooth(false)
{
    ...
    changePresetCamera();
    //std::copy(&tempOulu[0][0], &tempOulu[0][0]+8*12,&matriz[0][0]);

    //this->&tempOulu[!2] = *matriz;

    //float newArray[4][4];
    memcpy(tempOulu, matriz, sizeof(tempOulu));
...
void GraphModifier::resetTemperatureData()
{
    // Set up data
    /*
    static const float tempOulu1[8][12] = {
    ...
    static const float tempOulu[5][5] = {
        {-3.7f, -7.8f, -5.4f, 3.4f, 10.7f},      // 2006
        {-1.2f, -7.5f, 3.1f, 5.5f, 10.3f},       // 2007
        {-0.6f, 1.2f, 0.2f, 6.3f, 10.2f},        // 2008
        {-2.9f, -3.5f, -0.9f, 4.7f, 10.9f},     // 2009
        {-10.2f, -8.0f, -1.9f, 6.6f, 11.3f},   // 2010
